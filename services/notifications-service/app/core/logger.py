...
Uso:
    ...
    log_event("NOTIF", "EMAIL", "info", "Correo enviado a user@example.com")
...
def log_event(
    ...
    Args:
        module: Etiqueta del modulo (ej: "NOTIF", "EMAIL", "MAIN").
        stage: Etiqueta de la etapa (ej: "REQUEST", "SEND", "RABBITMQ").
