...
Uso:
    ...
    log_event("AUTH", "LOGIN", "info", "Login exitoso para credencial xyz")
...
def log_event(
    ...
    Args:
        module: Etiqueta del modulo (ej: "AUTH", "JWT", "MAIN").
        stage: Etiqueta de la etapa (ej: "REQUEST", "LOGIN", "HTTP").
